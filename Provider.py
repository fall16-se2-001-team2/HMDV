class Provider:
    ...
    # -------------------------------------------------------------
    def _init_(self, name, address, city, state, zip, eligibility, defaultRadius, multiplier, isMobile=False):
    ...
    # -------------------------------------------------------------
    def _init_(self, name, address, city, state, zip, eligibility, isMobile, radius, fade):
        self.address = address
        #self.address2 = address2
        self.name = name
        self.city = city
    ...
    def __repr__(self):
        ...
        strOut = "{lat: " + self.latitude + ", lng: " + self.longitude + ", count: " + self.weight + + ", radius: " + self.ru + "}"
        return strOut
